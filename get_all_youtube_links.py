...
playlist_id = 'PLx0ErPjtWhPuMEgM3R9anuaO-gBYw4UK5'
...
output_file = open(os.getcwd() + '/2_25_23.json', 'w')
...
response = client.add_video_to_playlist([video.split('=')[1] for video in youtube_links])
